...
| [Desktop browser capability](desktop-browser-capability.md) | Local Experience | Should Desktop own a visible browser that the Agent can inspect and operate, and what evidence would justify embedding it in the workspace? | Research only; no BuildMax browser prototype or implementation |
